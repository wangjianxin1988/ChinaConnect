...
export function getCurrentLanguage(): Language {
  ...
  if (browserLang.startsWith('zh')) return browserLang.startsWith('zh-TW') || browserLang.startsWith('zh-HK') ? 'zh-TW' : 'zh-CN';
...
function isValidLanguage(lang: string): lang is Language {
  return ['en', 'ja', 'ko', 'zh-CN', 'zh-TW', 'th', 'vi', 'ru', 'fr', 'de', 'ar', 'fa'].includes(lang);
}
