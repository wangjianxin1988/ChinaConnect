...
### Setup
- `supabase-skill install` — global setup (interactive wizard, adds to ~/.Codex/AGENTS.md)
- `supabase-skill init` — per-project setup (AGENTS.md + .env + .gitignore)
- `supabase-skill docs` — output LLM instruction snippet
- `supabase-skill docs --format Codex` — AGENTS.md format
