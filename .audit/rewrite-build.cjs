const fs = require("fs");
const out = `import { readdirSync, readFileSync, statSync, writeFileSync, mkdirSync, existsSync } from 'fs';
...
`;
fs.writeFileSync("build-i18n-content.mjs", out, "utf8");
console.log("rewritten, length:", out.length);
