...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    home: {
      ...
      pageDescription:
        "Discover China with AI-powered city guides. Find the best restaurants (Michelin & Black Pearl), attractions, transport info, and emergency contacts in 12 major Chinese cities including Beijing, Shanghai, Guangzhou, Xi'an, Chengdu, and more.",
      onboardingSkip: "Skip",
      ...
      onboarding2Desc:
        "Get personalized recommendations and insider knowledge from our AI assistant.",
      onboarding3Title: "Travel with Confidence",
      onboarding3Desc:
        "Access emergency contacts, transport info, and cultural tips all in one place.",
      onboardingNext: "Next",
  ...
  ja: {
    ...
    home: {
      ...
      pageTitle: "ChinaConnect - 中国探訪のためのAIガイド",
      pageDescription:
        "AI搭載のシティガイドで中国を発見。北京、上海、広州、西安、成都など12の主要都市で、ミシュラン＆黒真珠のレストラン、観光スポット、交通情報、緊急連絡先が見つかります。",
      onboardingSkip: "スキップ",
      onboarding1Title: "絶品グルメを発見",
      onboarding1Desc: "12の中国都市でミシュラン星付きと黒真珠のレストランを見つけよう。",
      onboarding2Title: "AIによるヒント",
      onboarding2Desc: "AIアシスタントから個別の推薦と現地の知識を得よう。",
      onboarding3Title: "安心して旅する",
      onboarding3Desc: "緊急連絡先、交通情報、文化 Tips を一箇所で。",
      onboardingNext: "次へ",
      onboardingFinish: "完了",
    },
    cities: {
    ...
    notFound: {
      ...
      primary: "ページが見つかりません",
      descriptionText:
        "お探しのページは存在しないか、移動されました。もう一度正しいページにお戻りください。",
      goHome: "ホームへ",
      exploreCities: "都市を探す",
      askAi: "AI に質問する",
    },
    ...
    accountPage: {
      ...
      usageDailyAi: "1日のAIリクエスト",
      usageSavedRoutes: "保存済みルート",
      usageFavorites: "お気に入り",
      sectionSavedRoutes: "保存済みルート",
      sectionFavorites: "お気に入り",
      sectionRecentOrders: "最近の注文",
      emptySavedRoutes: "保存済みルートはありません。",
      emptyFavorites: "お気に入りはありません。",
      emptyOrders: "注文はありません。",
      emptySavedRoutesHint: "保存済みルートはありません。AIとの会話でルートを作成しましょう！",
      emptyFavoritesHint:
        "お気に入りはありません。都市やレストランを閲覧してお気に入りに追加しましょう！",
      pointsUnit: "ポイント",
      alertSignOutError:
        "サブスクリプション管理を開けませんでした。サポートまでお問い合わせください。",
    ...
    offlinePage: {
      title: "オフラインです",
      bannerTitle: "オフラインモード",
      tryAgain: "再試行",
      tipsHeading: "オフライン時の旅行のヒント",
      tipsList1: "オフラインになる前に重要なフレーズと住所を保存してください。",
      tipsList2: "マップアプリでオフラインマップをダウンロードしてください。",
      tipsList3: "ホテル予約のスクリーンショットを保管してください。",
      tipsList4: "ホテル Wi-Fi を利用して母国へのビデオ通話ができます。",
      tipsList5: "ほとんどのカフェやモールでは無料 Wi-Fi が利用可能です。",
      tipsList6: "住所を書くための小型メモ帳を持ち歩きましょう。",
      phrase1En: "助けて！",
      phrase2En: "警察を呼んで！",
      phrase3En: "救急車が必要です",
      phrase4En: "火事！",
  ...
  ko: {
    ...
    home: {
      ...
      pageDescription:
        "AI 기반 도시 가이드로 중국을 발견하세요. 미슐랭 및 흑진주 레스토랑, 명소, 교통 정보, 긴급 연락처를 베이징, 상하이, 광저우, 시안, 청두 등 12개 주요 중국 도시에서 만나보세요.",
      onboardingSkip: "건너뛰기",
      onboarding1Title: "훌륭한 음식을 발견하세요",
      onboarding1Desc: "12개 중국 도시에서 미슐랭 스타와 블랙펄 레스토랑을 찾아보세요.",
      onboarding2Title: "AI 기반 팁",
      onboarding2Desc: "AI 어시스턴트의 개인 맞춤 추천과 현지 지식을 받아보세요.",
      onboarding3Title: "자신감 있게 여행하세요",
      onboarding3Desc: "긴급 연락처, 교통 정보, 문화 팁을 한곳에서 확인하세요.",
      onboardingNext: "다음",
      onboardingFinish: "완료",
    },
    cities: {
    ...
    notFound: {
      ...
      heading: "404",
      primary: "페이지를 찾을 수 없음",
      descriptionText:
        "찾으시는 페이지가 존재하지 않거나 이동되었습니다. 다시 올바른 경로로 안내해 드리겠습니다.",
      goHome: "홈으로",
      exploreCities: "도시 탐험",
      askAi: "AI에게 질문하기",
    },
    ...
    accountPage: {
      ...
      usageDailyAi: "일일 AI 요청",
      usageSavedRoutes: "저장된 경로",
      usageFavorites: "즐겨찾기",
      sectionSavedRoutes: "저장된 경로",
      sectionFavorites: "즐겨찾기",
      sectionRecentOrders: "최근 주문",
      emptySavedRoutes: "저장된 경로가 없습니다.",
      emptyFavorites: "즐겨찾기가 없습니다.",
      emptyOrders: "주문이 없습니다.",
      emptySavedRoutesHint: "저장된 경로가 없습니다. AI와 대화하여 경로를 만들어 보세요!",
      emptyFavoritesHint: "즐겨찾기가 없습니다. 도시와 식당을 둘러보고 즐겨찾기에 추가하세요!",
      pointsUnit: "포인트",
      alertSignOutError: "구독 관리를 열 수 없습니다. 지원팀에 문의해 주세요.",
    ...
    offlinePage: {
      ...
      bannerTitle: "오프라인 모드",
      tryAgain: "다시 시도",
      tipsHeading: "오프라인 상태에서의 여행 팁",
      tipsList1: "오프라인이 되기 전에 중요한 문장과 주소를 저장하세요.",
      tipsList2: "지도 앱에서 오프라인 지도를 다운로드하세요.",
      tipsList3: "호텔 예약 화면을 캡처해 두세요.",
      tipsList4: "호텔 Wi-Fi를 이용해 본국과 영상 통화를 하세요.",
      tipsList5: "대부분의 카페와 쇼핑몰에는 무료 Wi-Fi가 있습니다.",
      tipsList6: "주소를 적을 작은 수첩을随身携带하세요.",
      phrase1En: "도와주세요!",
      phrase2En: "경찰을 불러주세요!",
      phrase3En: "구급차가 필요합니다",
      phrase4En: "불이야!",
      phrase5En: "길을 잃었어요",
      phrase6En: "도움이 필요해요",
      phrase7En: "병원이 어디예요?",
  ...
  th: {
    ...
    home: {
      ...
      pageTitle: "ChinaConnect - คู่มือ AI สำหรับสำรวจจีน",
      pageDescription:
        "สำรวจจีนด้วยคู่มือเมืองจาก AI ค้นหาร้านอาหารมิชลินและแบล็กเพิร์ล สถานที่ท่องเที่ยว ข้อมูลการเดินทาง และข้อมูลติดต่อฉุกเฉินใน 12 เมืองหลักของจีน รวมถึงปักกิ่ง เซี่ยงไฮ้ กว่างโจว ซีอาน เฉิงตู และอื่นๆ",
      onboardingSkip: "ข้าม",
      onboarding1Title: "ค้นพบอาหารชั้นเลิศ",
      onboarding1Desc: "ค้นหาร้านอาหารมิชลินและแบล็กเพิร์ลใน 12 เมืองจีน",
      onboarding2Title: "เคล็ดลับจาก AI",
      onboarding2Desc: "รับคำแนะนำส่วนตัวและความรู้จากผู้ช่วย AI",
      onboarding3Title: "เดินทางอย่างมั่นใจ",
      onboarding3Desc: "เข้าถึงข้อมูลติดต่อฉุกเฉิน การเดินทาง และเคล็ดลับวัฒนธรรมได้ในที่เดียว",
    ...
    notFound: {
      title: "ไม่พบหน้านี้ - ChinaConnect",
      description: "หน้าที่คุณกำลังมองหาไม่มีอยู่",
      heading: "404",
      primary: "ไม่พบหน้านี้",
      descriptionText: "หน้าที่คุณกำลังมองหาไม่มีอยู่หรือถูกย้ายไปแล้ว เราจะพาคุณกลับมาที่เส้นทางที่ถูกต้อง",
      goHome: "กลับหน้าแรก",
      exploreCities: "สำรวจเมือง",
      askAi: "ถาม ChinaGuide AI",
    },
    emergencyPage: {
    ...
    accountPage: {
      ...
      aiRequestsThisMonth: "คำขอ AI เดือนนี้",
      ...
      usageDailyAi: "คำขอ AI รายวัน",
      usageSavedRoutes: "เส้นทางที่บันทึก",
      usageFavorites: "รายการโปรด",
      sectionSavedRoutes: "เส้นทางที่บันทึก",
      sectionFavorites: "รายการโปรด",
      sectionRecentOrders: "คำสั่งซื้อล่าสุด",
      emptySavedRoutes: "ยังไม่มีเส้นทางที่บันทึก",
      emptyFavorites: "ยังไม่มีรายการโปรด",
      emptyOrders: "ยังไม่มีคำสั่งซื้อ",
      emptySavedRoutesHint: "ยังไม่มีเส้นทางที่บันทึก เริ่มสนทนากับ AI เพื่อสร้างเส้นทาง!",
      emptyFavoritesHint: "ยังไม่มีรายการโปรด เรียกดูเมืองและร้านอาหารเพื่อเพิ่มรายการโปรด!",
      pointsUnit: "คะแนน",
      alertSignOutError: "ไม่สามารถเปิดการจัดการการสมัครสมาชิกได้ กรุณาติดต่อฝ่ายสนับสนุน",
      untitledRoute: "เส้นทางไม่มีชื่อ",
      savedLocally: "บันทึกในเครื่องเท่านั้น",
      syncedToCloud: "ซิงค์ไปยังคลาวด์แล้ว",
      deleteAction: "ลบ",
      deleteRouteConfirm: "ลบเส้นทางนี้หรือไม่?",
      orderHeaderOrderNum: "เลขที่คำสั่งซื้อ",
      orderHeaderType: "ประเภท",
      orderHeaderAmount: "จำนวนเงิน",
    ...
    offlinePage: {
      ...
      tipsHeading: "เคล็ดลับการเดินทางขณะออฟไลน์",
      tipsList1: "บันทึกวลีและที่อยู่สำคัญก่อนออฟไลน์",
      tipsList2: "ดาวน์โหลดแผนที่ออฟไลน์ในแอปแผนที่ของคุณ",
      tipsList3: "เก็บภาพหน้าจอการจองโรงแรมไว้",
      tipsList4: "ใช้ Wi-Fi ของโรงแรมสำหรับวิดีโอคอลกลับบ้าน",
      tipsList5: "ร้านกาแฟและห้างสรรพสินค้าส่วนใหญ่มี Wi-Fi ฟรี",
      tipsList6: "พกสมุดเล็กๆ สำหรับจดที่อยู่",
      phrase1En: "ช่วยด้วย!",
      phrase2En: "เรียกตำรวจ!",
      phrase3En: "ฉันต้องการรถพยาบาล",
      phrase4En: "ไฟไหม้!",
      phrase5En: "ฉันหลงทาง",
      phrase6En: "ฉันต้องการความช่วยเหลือ",
      phrase7En: "โรงพยาบาลอยู่ที่ไหน?",
    },
    profilePage: {
  ...
  vi: {
    ...
    home: {
      ...
      pageTitle: "ChinaConnect - Hướng dẫn AI khám phá Trung Quốc",
      pageDescription:
        "Khám phá Trung Quốc với hướng dẫn thành phố bằng AI. Tìm nhà hàng Michelin và Black Pearl, điểm tham quan, thông tin giao thông và liên hệ khẩn cấp tại 12 thành phố lớn của Trung Quốc bao gồm Bắc Kinh, Thượng Hải, Quảng Châu, Tây An, Thành Đô và hơn thế nữa.",
      onboardingSkip: "Bỏ qua",
      onboarding1Title: "Khám phá ẩm thực tuyệt vời",
      onboarding1Desc: "Tìm nhà hàng Michelin và Black Pearl tại 12 thành phố Trung Quốc.",
      onboarding2Title: "Mẹo từ AI",
      onboarding2Desc: "Nhận đề xuất cá nhân hóa và kiến thức địa phương từ trợ lý AI.",
      onboarding3Title: "Du lịch tự tin",
      onboarding3Desc: "Truy cập liên hệ khẩn cấp, thông tin giao thông và mẹo văn hóa ở một nơi.",
    ...
    notFound: {
      ...
      descriptionText:
        "Trang bạn đang tìm không tồn tại hoặc đã được di chuyển. Hãy để chúng tôi đưa bạn quay lại đúng hướng.",
      goHome: "Về trang chủ",
      exploreCities: "Khám phá thành phố",
      askAi: "Hỏi ChinaGuide AI",
    },
    emergencyPage: {
    ...
    accountPage: {
      ...
      aiRequestsThisMonth: "Yêu cầu AI tháng này",
      ...
      usageDailyAi: "Yêu cầu AI hằng ngày",
      usageSavedRoutes: "Tuyến đường đã lưu",
      usageFavorites: "Yêu thích",
      sectionSavedRoutes: "Tuyến đường đã lưu",
      sectionFavorites: "Yêu thích",
      sectionRecentOrders: "Đơn hàng gần đây",
      emptySavedRoutes: "Chưa có tuyến đường đã lưu.",
      emptyFavorites: "Chưa có mục yêu thích.",
      emptyOrders: "Chưa có đơn hàng.",
      emptySavedRoutesHint: "Chưa có tuyến đường đã lưu. Hãy trò chuyện với AI để tạo tuyến đường!",
      emptyFavoritesHint:
        "Chưa có mục yêu thích. Khám phá thành phố và nhà hàng để thêm vào yêu thích!",
      pointsUnit: "điểm",
      alertSignOutError: "Không thể mở quản lý đăng ký. Vui lòng liên hệ hỗ trợ.",
      untitledRoute: "Tuyến đường chưa đặt tên",
      savedLocally: "Chỉ lưu cục bộ",
      syncedToCloud: "Đã đồng bộ lên đám mây",
      deleteAction: "Xóa",
      deleteRouteConfirm: "Xóa tuyến đường này?",
      orderHeaderOrderNum: "Mã đơn",
    ...
    offlinePage: {
      ...
      tipsList1: "Lưu các cụm từ và địa chỉ quan trọng trước khi ngoại tuyến.",
      tipsList2: "Tải bản đồ ngoại tuyến trong ứng dụng bản đồ của bạn.",
      tipsList3: "Giữ ảnh chụp màn hình đặt phòng khách sạn.",
      tipsList4: "Dùng Wi-Fi khách sạn để gọi video về nhà.",
      tipsList5: "Hầu hết quán cà phê và trung tâm mua sắm có Wi-Fi miễn phí.",
      tipsList6: "Mang theo sổ tay nhỏ để ghi địa chỉ.",
      phrase1En: "Cứu tôi!",
      phrase2En: "Gọi cảnh sát!",
      phrase3En: "Tôi cần xe cứu thương",
      phrase4En: "Cháy!",
  ...
  ru: {
    ...
    home: {
      ...
      pageTitle: "ChinaConnect - Ваш ИИ-гид по Китаю",
      pageDescription:
        "Откройте Китай с помощью ИИ-гидов по городам. Найдите рестораны Michelin и Black Pearl, достопримечательности, информацию о транспорте и экстренные контакты в 12 крупных китайских городах, включая Пекин, Шанхай, Гуанчжоу, Сиань, Чэнду и другие.",
      onboardingSkip: "Пропустить",
      onboarding1Title: "Откройте отличную кухню",
      onboarding1Desc: "Найдите рестораны Michelin и Black Pearl в 12 городах Китая.",
      onboarding2Title: "Советы от ИИ",
      onboarding2Desc: "Получите персональные рекомендации и знания местных от ИИ-ассистента.",
      onboarding3Title: "Путешествуйте уверенно",
      onboarding3Desc: "Экстренные контакты, транспорт и культурные советы в одном месте.",
    ...
    notFound: {
      ...
      descriptionText:
        "Страница, которую вы ищете, не существует или была перемещена. Позвольте помочь вам вернуться.",
      goHome: "На главную",
      exploreCities: "Исследовать города",
      askAi: "Спросить ChinaGuide AI",
    },
    emergencyPage: {
    ...
    accountPage: {
      ...
      aiRequestsThisMonth: "Запросы ИИ в этом месяце",
      statSavedRoutes: "Сохранённые маршруты",
      upgrade: "Улучшить",
      currentPlan: "Текущий тариф",
      renewsOn: "Продление",
      active: "Активен",
      manageSubscription: "Управление подпиской",
      usageDailyAi: "Запросы ИИ в день",
      usageSavedRoutes: "Сохранённые маршруты",
      usageFavorites: "Избранное",
      sectionSavedRoutes: "Сохранённые маршруты",
      sectionFavorites: "Избранное",
      sectionRecentOrders: "Недавние заказы",
      emptySavedRoutes: "Сохранённых маршрутов пока нет.",
      emptyFavorites: "Избранного пока нет.",
      emptyOrders: "Заказов пока нет.",
      emptySavedRoutesHint:
        "Сохранённых маршрутов пока нет. Начните разговор с ИИ, чтобы создать маршруты!",
      emptyFavoritesHint:
        "Избранного пока нет. Изучайте города и рестораны, чтобы добавить в избранное!",
      pointsUnit: "баллов",
      alertSignOutError: "Не удалось открыть управление подпиской. Свяжитесь с поддержкой.",
      untitledRoute: "Безымянный маршрут",
      savedLocally: "Только локально",
      syncedToCloud: "Синхронизировано с облаком",
      deleteAction: "Удалить",
      deleteRouteConfirm: "Удалить этот маршрут?",
      orderHeaderOrderNum: "Номер заказа",
      orderHeaderType: "Тип",
    ...
    offlinePage: {
      ...
      tryAgain: "Повторить",
      tipsHeading: "Советы для путешествий без интернета",
      tipsList1: "Сохраните важные фразы и адреса перед выходом из сети.",
      tipsList2: "Скачайте офлайн-карты в приложении карт.",
      tipsList3: "Сохраните скриншот бронирования отеля.",
      tipsList4: "Используйте Wi-Fi отеля для видеозвонков домой.",
      tipsList5: "В большинстве кафе и ТЦ есть бесплатный Wi-Fi.",
      tipsList6: "Носите с собой блокнот для записи адресов.",
      phrase1En: "Помогите!",
      phrase2En: "Вызовите полицию!",
      phrase3En: "Мне нужна скорая",
      phrase4En: "Пожар!",
      phrase5En: "Я потерялся",
      phrase6En: "Мне нужна помощь",
      phrase7En: "Где больница?",
    },
    profilePage: {
  ...
  fr: {
    ...
    home: {
      ...
      pageTitle: "ChinaConnect - Votre guide IA pour explorer la Chine",
      pageDescription:
        "Découvrez la Chine avec des guides de villes propulsés par l'IA. Trouvez les meilleurs restaurants (Michelin et Black Pearl), attractions, infos transport et contacts d'urgence dans 12 grandes villes chinoises : Pékin, Shanghai, Guangzhou, Xi'an, Chengdu et plus.",
      onboardingSkip: "Passer",
      onboarding1Title: "Découvrez une cuisine exceptionnelle",
      onboarding1Desc: "Trouvez des restaurants Michelin et Black Pearl dans 12 villes chinoises.",
      onboarding2Title: "Conseils par IA",
      onboarding2Desc:
        "Recevez des recommandations personnalisées et des conseils locaux de notre assistant IA.",
      onboarding3Title: "Voyagez en confiance",
      onboarding3Desc:
    ...
    notFound: {
      ...
      descriptionText:
        "La page que vous cherchez n'existe pas ou a été déplacée. Permettez-nous de vous remettre sur la bonne voie.",
      goHome: "Accueil",
      exploreCities: "Explorer les villes",
      askAi: "Demander à ChinaGuide AI",
    },
    emergencyPage: {
    ...
    accountPage: {
      ...
      aiRequestsThisMonth: "Requêtes IA ce mois-ci",
      ...
      usageDailyAi: "Requêtes IA quotidiennes",
      ...
      emptySavedRoutesHint:
        "Aucun itinéraire enregistré. Discutez avec l'IA pour créer des itinéraires !",
      emptyFavoritesHint: "Aucun favori. Parcourez les villes et restaurants pour en ajouter !",
      pointsUnit: "points",
      alertSignOutError:
        "Impossible d'ouvrir la gestion de l'abonnement. Veuillez contacter le support.",
    ...
    offlinePage: {
      ...
      tipsList1: "Enregistrez les phrases et adresses clés avant de perdre la connexion.",
      tipsList2: "Téléchargez des cartes hors ligne dans votre application de cartes.",
      tipsList3: "Gardez une capture d'écran de votre réservation d'hôtel.",
      tipsList4: "Utilisez le Wi-Fi de l'hôtel pour les appels vidéo.",
      tipsList5: "La plupart des cafés et centres commerciaux ont le Wi-Fi gratuit.",
      tipsList6: "Ayez un petit carnet pour noter les adresses.",
  ...
  de: {
    ...
    home: {
      ...
      pageTitle: "ChinaConnect - Dein KI-Guide für China",
      pageDescription:
        "Entdecke China mit KI-gestützten Stadtführern. Finde die besten Restaurants (Michelin & Black Pearl), Sehenswürdigkeiten, Verkehrsinfos und Notfallkontakte in 12 großen chinesischen Städten wie Peking, Shanghai, Guangzhou, Xi'an, Chengdu und mehr.",
      onboardingSkip: "Überspringen",
      onboarding1Title: "Entdecke großartiges Essen",
      onboarding1Desc: "Finde Michelin- und Black-Pearl-Restaurants in 12 chinesischen Städten.",
      onboarding2Title: "KI-gestützte Tipps",
      onboarding2Desc:
        "Erhalte persönliche Empfehlungen und Insiderwissen von unserem KI-Assistenten.",
      onboarding3Title: "Reise mit Vertrauen",
      onboarding3Desc: "Notfallkontakte, Verkehrs- und Kulturhinweise an einem Ort.",
    ...
    notFound: {
      ...
      descriptionText:
        "Die gesuchte Seite existiert nicht oder wurde verschoben. Lassen Sie uns Ihnen helfen, den richtigen Weg zu finden.",
      goHome: "Zur Startseite",
      exploreCities: "Städte erkunden",
      askAi: "ChinaGuide AI fragen",
    },
    emergencyPage: {
    ...
    accountPage: {
      ...
      aiRequestsThisMonth: "KI-Anfragen diesen Monat",
      ...
      emptySavedRoutesHint:
        "Noch keine gespeicherten Routen. Starte ein Gespräch mit der KI, um Routen zu erstellen!",
      emptyFavoritesHint:
        "Noch keine Favoriten. Durchstöbere Städte und Restaurants, um Favoriten hinzuzufügen!",
      pointsUnit: "Punkte",
      alertSignOutError: "Abo-Verwaltung konnte nicht geöffnet werden. Bitte Support kontaktieren.",
      untitledRoute: "Unbenannte Route",
      savedLocally: "Nur lokal gespeichert",
      syncedToCloud: "Mit Cloud synchronisiert",
      deleteAction: "Löschen",
      deleteRouteConfirm: "Diese Route löschen?",
    ...
    offlinePage: {
      ...
      tipsHeading: "Reisetipps für unterwegs ohne Internet",
      tipsList1: "Speichern Sie wichtige Sätze und Adressen, bevor Sie offline gehen.",
      tipsList2: "Laden Sie Offline-Karten in Ihrer Karten-App herunter.",
      tipsList3: "Machen Sie einen Screenshot Ihrer Hotelbuchung.",
      tipsList4: "Nutzen Sie das Hotel-WLAN für Videoanrufe nach Hause.",
      tipsList5: "Die meisten Cafés und Einkaufszentren bieten kostenloses WLAN.",
      tipsList6: "Tragen Sie ein kleines Notizbuch für Adressen bei sich.",
      phrase1En: "Hilfe!",
      phrase2En: "Rufen Sie die Polizei!",
      phrase3En: "Ich brauche einen Krankenwagen",
      phrase4En: "Feuer!",
      phrase5En: "Ich habe mich verlaufen",
  ...
  ar: {
    ...
    home: {
      ...
      pageTitle: "ChinaConnect - دليلك الذكي لاستكشاف الصين",
      pageDescription:
        "اكتشف الصين من خلال أدلة المدن المدعومة بالذكاء الاصطناعي. اعثر على أفضل المطاعم (ميشلان وبلاك بيرل) والمعالم ومعلومات النقل وجهات الاتصال الطارئة في 12 مدينة صينية كبرى بما في ذلك بكين وشانغهاي وقوانغتشو وشيان وتشنغدو والمزيد.",
      onboardingSkip: "تخطي",
      onboarding1Title: "اكتشف طعامًا رائعًا",
      onboarding1Desc: "اعثر على مطاعم ميشلان وبلاك بيرل في 12 مدينة صينية.",
      onboarding2Title: "نصائح مدعومة بالذكاء الاصطناعي",
      onboarding2Desc: "احصل على توصيات شخصية ومعرفة محلية من مساعد الذكاء الاصطناعي.",
      onboarding3Title: "سافر بثقة",
      onboarding3Desc:
        "الوصول إلى جهات الاتصال الطارئة ومعلومات النقل والنصائح الثقافية في مكان واحد.",
    ...
    accountPage: {
      ...
      aiRequestsThisMonth: "طلبات الذكاء الاصطناعي هذا الشهر",
      ...
      usageFavorites: "المفضلة",
      sectionSavedRoutes: "المسارات المحفوظة",
      sectionFavorites: "المفضلة",
      sectionRecentOrders: "الطلبات الأخيرة",
      emptySavedRoutes: "لا توجد مسارات محفوظة بعد.",
      emptyFavorites: "لا توجد مفضلات بعد.",
      emptyOrders: "لا توجد طلبات بعد.",
      emptySavedRoutesHint:
        "لا توجد مسارات محفوظة بعد. ابدأ محادثة مع الذكاء الاصطناعي لإنشاء المسارات!",
      emptyFavoritesHint: "لا توجد مفضلات بعد. تصفح المدن والمطاعم لإضافة مفضلاتك!",
      pointsUnit: "نقاط",
    ...
    offlinePage: {
      ...
      tipsHeading: "نصائح السفر بدون اتصال",
      tipsList1: "احفظ العبارات والعناوين المهمة قبل فقدان الاتصال.",
      tipsList2: "حمّل الخرائط دون اتصال في تطبيق الخرائط.",
      tipsList3: "احتفظ بلقطة شاشة لحجز الفندق.",
      tipsList4: "استخدم Wi-Fi الفندق لإجراء مكالمات فيديو.",
      tipsList5: "معظم المقاهي والمراكز التجارية توفر Wi-Fi مجاني.",
      tipsList6: "احمل دفتراً صغيراً لتدوين العناوين.",
      phrase1En: "النجدة!",
      phrase2En: "استدعِ الشرطة!",
  ...
  fa: {
    ...
    home: {
      ...
      pageTitle: "ChinaConnect - راهنمای هوش مصنوعی شما برای کاوش چین",
      pageDescription:
        "چین را با راهنماهای شهری مبتنی بر هوش مصنوعی کشف کنید. بهترین رستوران‌ها (میشلن و بلک پرل)، جاذبه‌ها، اطلاعات حمل‌ونقل و تماس‌های اضطراری را در ۱۲ شهر بزرگ چین از جمله پکن، شانگهای، گوانگژو، شی‌آن، چنگدو و بیشتر بیابید.",
      onboardingSkip: "رد شدن",
      onboarding1Title: "غذاهای عالی کشف کنید",
      onboarding1Desc: "رستوران‌های میشلن و بلک پرل را در ۱۲ شهر چین بیابید.",
      onboarding2Title: "نکات از هوش مصنوعی",
      onboarding2Desc: "پیشنهادهای شخصی‌سازی‌شده و دانش محلی از دستیار هوش مصنوعی بگیرید.",
      onboarding3Title: "با اطمینان سفر کنید",
      onboarding3Desc: "دسترسی به تماس‌های اضطراری، اطلاعات حمل‌ونقل و نکات فرهنگی در یک‌جا.",
      onboardingNext: "بعدی",
    ...
    notFound: {
      title: "صفحه یافت نشد - ChinaConnect",
      description: "صفحه‌ای که به دنبال آن هستید وجود ندارد.",
      heading: "404",
      primary: "صفحه یافت نشد",
      descriptionText:
        "صفحه‌ای که به دنبال آن هستید وجود ندارد یا جابجا شده است. اجازه دهید شما را به مسیر درست برگردانیم.",
      goHome: "صفحه اصلی",
      exploreCities: "کاوش شهرها",
      askAi: "از ChinaGuide AI بپرسید",
    },
    emergencyPage: {
    ...
    accountPage: {
      ...
      usageFavorites: "علاقه‌مندی‌ها",
      sectionSavedRoutes: "مسیرهای ذخیره‌شده",
      sectionFavorites: "علاقه‌مندی‌ها",
      sectionRecentOrders: "سفارش‌های اخیر",
      emptySavedRoutes: "هنوز مسیری ذخیره نشده است.",
      emptyFavorites: "هنوز علاقه‌مندی وجود ندارد.",
      emptyOrders: "هنوز سفارشی ثبت نشده است.",
      emptySavedRoutesHint: "هنوز مسیری ذخیره نشده است. برای ساخت مسیر با هوش مصنوعی گفتگو کنید!",
      emptyFavoritesHint:
        "هنوز علاقه‌مندی وجود ندارد. برای افزودن به علاقه‌مندی‌ها، شهرها و رستوران‌ها را مرور کنید!",
      pointsUnit: "امتیاز",
      alertSignOutError: "مدیریت اشتراک باز نشد. لطفاً با پشتیبانی تماس بگیرید.",
      untitledRoute: "مسیر بدون عنوان",
      savedLocally: "فقط به‌صورت محلی ذخیره شد",
      syncedToCloud: "با ابر همگام‌سازی شد",
      deleteAction: "حذف",
      deleteRouteConfirm: "این مسیر حذف شود؟",
    ...
    offlinePage: {
      ...
      tipsList1: "عبارات و آدرس‌های مهم را قبل از آفلاین شدن ذخیره کنید.",
      tipsList2: "نقشه‌های آفلاین را در اپ نقشه دانلود کنید.",
      tipsList3: "از رزرو هتل اسکرین‌شات بگیرید.",
      tipsList4: "برای تماس تصویری از Wi-Fi هتل استفاده کنید.",
      tipsList5: "اکثر کافه‌ها و مراکز خرید Wi-Fi رایگان دارند.",
      tipsList6: "یک دفترچه کوچک برای نوشتن آدرس‌ها همراه داشته باشید.",
      phrase1En: "کمک!",
      phrase2En: "پلیس را خبر کنید!",
      phrase3En: "به آمبولانس نیاز دارم",
      phrase4En: "آتش!",
      phrase5En: "گم شده‌ام",
      phrase6En: "به کمک نیاز دارم",
  ...
  "zh-CN": {
    ...
    home: {
      ...
      chatWithAI: "与 AI 对话",
      exploreBeijing: "探索北京",
      pageTitle: "ChinaConnect - 中国探索的 AI 智能向导",
      pageDescription:
        "借助 AI 城市指南探索中国。在北京、上海、广州、西安、成都等 12 个主要中国城市中寻找米其林与黑珍珠餐厅、景点、交通信息和紧急联系方式。",
      onboardingSkip: "跳过",
      onboarding1Title: "发现地道美食",
      onboarding1Desc: "在 12 个中国城市中寻找米其林星级与黑珍珠餐厅。",
      onboarding2Title: "AI 智能推荐",
      onboarding2Desc: "从 AI 助手获取个性化推荐与本地达人攻略。",
      onboarding3Title: "安心出游",
      onboarding3Desc: "紧急联系、交通信息和当地贴士，一站掌握。",
      onboardingNext: "下一步",
      onboardingFinish: "完成",
    },
    cities: {
    ...
    notFound: {
      ...
      heading: "404",
      primary: "页面未找到",
      descriptionText: "您要查找的页面不存在或已被移动。让我们帮您回到正轨。",
      goHome: "返回首页",
      exploreCities: "探索城市",
      askAi: "询问 ChinaGuide AI",
    },
    emergencyPage: {
      title: "紧急联系与帮助",
    ...
    accountPage: {
      ...
      usageDailyAi: "每日 AI 请求",
      usageSavedRoutes: "已保存路线",
      usageFavorites: "收藏",
      sectionSavedRoutes: "已保存路线",
      sectionFavorites: "收藏",
      sectionRecentOrders: "最近订单",
      emptySavedRoutes: "暂无已保存路线。",
      emptyFavorites: "暂无收藏。",
      emptyOrders: "暂无订单。",
      emptySavedRoutesHint: "暂无已保存路线。开始与 AI 对话来创建路线吧！",
      emptyFavoritesHint: "暂无收藏。浏览城市和餐厅即可添加收藏！",
      pointsUnit: "积分",
    ...
    offlinePage: {
      ...
      bannerTitle: "离线模式",
      tryAgain: "重试",
      tipsHeading: "离线时的旅行提示",
      tipsList1: "离线前保存重要短语和地址。",
      tipsList2: "在地图应用中下载离线地图。",
      tipsList3: "保留酒店预订的截图。",
      tipsList4: "使用酒店 Wi-Fi 与国内视频通话。",
      tipsList5: "大多数咖啡馆和商场都提供免费 Wi-Fi。",
      tipsList6: "随身携带小笔记本用于记录地址。",
      phrase1En: "救命！",
      phrase2En: "报警！",
      phrase3En: "我需要救护车",
      phrase4En: "着火了！",
  ...
  "zh-TW": {
    ...
    home: {
      ...
      chatWithAI: "與 AI 對話",
      exploreBeijing: "探索北京",
      pageTitle: "ChinaConnect - 中國探索的 AI 智慧導覽",
      pageDescription:
        "透過 AI 城市導覽探索中國。在北京、上海、廣州、西安、成都等 12 個主要中國城市中尋找米其林與黑珍珠餐廳、景點、交通資訊與緊急聯絡方式。",
      onboardingSkip: "略過",
      onboarding1Title: "發現絕佳美食",
      onboarding1Desc: "在 12 個中國城市中尋找米其林星級與黑珍珠餐廳。",
      onboarding2Title: "AI 智慧推薦",
      onboarding2Desc: "從 AI 助理取得個人化推薦與在地達人攻略。",
      onboarding3Title: "安心出遊",
      onboarding3Desc: "緊急聯絡、交通資訊與文化貼士，一站掌握。",
      onboardingNext: "下一步",
      onboardingFinish: "完成",
    },
    cities: {
    ...
    notFound: {
      title: "找不到頁面 - ChinaConnect",
      description: "您要尋找的頁面不存在。",
      heading: "404",
      primary: "找不到頁面",
      descriptionText: "您要尋找的頁面不存在或已被移動。讓我們幫您回到正軌。",
      goHome: "返回首頁",
      exploreCities: "探索城市",
      askAi: "詢問 ChinaGuide AI",
    },
    emergencyPage: {
      title: "緊急聯絡與協助",
    ...
    accountPage: {
      ...
      usageDailyAi: "每日 AI 請求",
      usageSavedRoutes: "已儲存路線",
      usageFavorites: "收藏",
      sectionSavedRoutes: "已儲存路線",
      sectionFavorites: "收藏",
      sectionRecentOrders: "近期訂單",
      emptySavedRoutes: "目前沒有已儲存的路線。",
      emptyFavorites: "目前沒有收藏。",
      emptyOrders: "目前沒有訂單。",
      emptySavedRoutesHint: "目前沒有已儲存的路線。與 AI 對話以建立路線！",
      emptyFavoritesHint: "目前沒有收藏。瀏覽城市與餐廳即可加入收藏！",
      pointsUnit: "點數",
      alertSignOutError: "無法開啟訂閱管理，請聯絡客服。",
      untitledRoute: "未命名路線",
      savedLocally: "僅本機儲存",
      syncedToCloud: "已同步至雲端",
      deleteAction: "刪除",
      deleteRouteConfirm: "確定要刪除這條路線嗎？",
    ...
    offlinePage: {
      ...
      bannerTitle: "離線模式",
      tryAgain: "重試",
      tipsHeading: "離線時的旅行提示",
      tipsList1: "離線前請儲存重要短語和地址。",
      tipsList2: "在地圖應用中下載離線地圖。",
      tipsList3: "保留飯店訂位的截圖。",
      tipsList4: "使用飯店 Wi-Fi 與國內視訊通話。",
      tipsList5: "大多數咖啡廳和商場都提供免費 Wi-Fi。",
      tipsList6: "隨身攜帶小筆記本用於記錄地址。",
      phrase1En: "救命！",
      phrase2En: "報警！",
      phrase3En: "我需要救護車",
      phrase4En: "著火了！",
