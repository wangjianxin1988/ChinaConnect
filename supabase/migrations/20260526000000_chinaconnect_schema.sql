...
-- ============================================================
-- INDEXES (conditional for existing tables)
-- ============================================================
...
-- Community posts indexes (only if table and column exist)
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'community_posts') THEN
        ...
        END IF;
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'community_posts' AND column_name = 'city_id') THEN
            CREATE INDEX IF NOT EXISTS idx_community_posts_city_id ON community_posts(city_id);
        END IF;
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'community_posts' AND column_name = 'type') THEN
            CREATE INDEX IF NOT EXISTS idx_community_posts_type ON community_posts(type);
        END IF;
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'community_posts' AND column_name = 'created_at') THEN
            CREATE INDEX IF NOT EXISTS idx_community_posts_created ON community_posts(created_at DESC);
        END IF;
        IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'community_posts' AND column_name = 'is_featured') THEN
...
-- Community posts trigger (only if table exists)
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'community_posts') THEN
        IF NOT EXISTS (SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'update_community_posts_updated_at') THEN
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'post_comments') THEN
        IF NOT EXISTS (SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'update_post_comments_updated_at') THEN
...
-- Scam reports trigger
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'scam_reports') THEN
        IF NOT EXISTS (SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'update_scam_reports_updated_at') THEN
...
-- Emergency info trigger
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'emergency_info') THEN
        IF NOT EXISTS (SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'update_emergency_info_updated_at') THEN
...
-- Blogger restaurants trigger
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'blogger_restaurants') THEN
        IF NOT EXISTS (SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'update_blogger_restaurants_updated_at') THEN
...
-- Price references trigger
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'price_references') THEN
        IF NOT EXISTS (SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'update_price_references_updated_at') THEN
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'post_likes') THEN
        IF NOT EXISTS (SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'after_like_insert') THEN
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'post_likes') THEN
        IF NOT EXISTS (SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'after_like_delete') THEN
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'cities') THEN
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'cities' AND column_name = 'fts') THEN
            ALTER TABLE cities ADD COLUMN fts tsvector
                GENERATED ALWAYS AS (
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'attractions') THEN
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'attractions' AND column_name = 'fts') THEN
            ALTER TABLE attractions ADD COLUMN fts tsvector
                GENERATED ALWAYS AS (
                    setweight(to_tsvector('english', coalesce(name_en, '')), 'A') ||
                    setweight(to_tsvector('simple', coalesce(name_zh, '')), 'A') ||
                    setweight(to_tsvector('english', coalesce(description, '')), 'B')
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'restaurants') THEN
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'restaurants' AND column_name = 'fts') THEN
            ALTER TABLE restaurants ADD COLUMN fts tsvector
                GENERATED ALWAYS AS (
                    setweight(to_tsvector('english', coalesce(name_en, '')), 'A') ||
                    setweight(to_tsvector('simple', coalesce(name_zh, '')), 'A') ||
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'community_posts') THEN
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'community_posts' AND column_name = 'fts') THEN
            ALTER TABLE community_posts ADD COLUMN fts tsvector
                GENERATED ALWAYS AS (
