...
const fixlist = JSON.parse(fs.readFileSync(".audit/_comp_fixlist.json", "utf8"));
...
fs.writeFileSync(".audit/_comp_fix_results.json", JSON.stringify(results, null, 1), "utf8");
