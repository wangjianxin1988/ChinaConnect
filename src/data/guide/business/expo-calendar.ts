...
export const EXPO_CALENDAR: Expo[] = [
  ...
  {
    id: "ciff",
    name: "China International Furniture Fair",
    nameCn: "中国家博会",
  ...
  {
    id: "cief",
    name: "China International Electronic Circuit Exhibition",
    nameCn: "国际电子电路展",
    frequency: "Yearly (November)",
    venue: "National Exhibition and Convention Center",
    city: "Shanghai",
    months: [11],
    description:
  ...
  },
  {
    ...
    frequency: "Twice yearly (March & October)",
    venue: "National Exhibition and Convention Center",
    city: "Shanghai",
    months: [3, 10],
  ...
  {
    id: "bj-expo",
    name: "Beijing International Horticultural Exposition",
    nameCn: "北京国际园艺博览会",
    frequency: "Periodic (2024 cycle)",
    venue: "Yanqing District",
    city: "Beijing",
    months: [4, 5],
    description:
      "International horticultural expo showcasing green technology and sustainable development.",
    descriptionCn: "展示绿色科技与可持续发展的国际园艺博览会。",
    category: "trade",
  },
  {
    id: "china-coast",
    ...
    months: [9],
    description:
      "Comprehensive trade in services fair covering culture, technology, education, healthcare, and finance.",
    descriptionCn: "涵盖文化、科技、教育、医疗、金融等领域的综合性服务贸易展会。",
