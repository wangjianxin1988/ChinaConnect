...
-- ============================================================
-- CITY SCORING SYSTEM (v1.1)
-- Multi-source city ranking and scoring system
-- ============================================================
...
-- City source data (raw data from each source)
...
-- City scores (calculated composite scores)
...
-- Indexes for city scoring system
...
-- View for city rankings
CREATE OR REPLACE VIEW city_rankings AS
SELECT
    c.id, c.slug, c.name_en, c.name_zh, c.province,
    cs.composite_score, cs.economy_score, cs.international_score,
    cs.tourism_score, cs.livability_score,
    cs.tier, cs.overall_rank,
...
INSERT INTO data_source_configs (source_name, source_type, fetch_interval_hours, is_active, config) VALUES
    ('yicai', 'yicai', 8760, true, '{"name_cn": "第一财经·新一线研究所", "url": "https://www.yicai.com/", "weight": 0.30}'),
    ('gawc', 'gawc', 8760, true, '{"name_cn": "GaWC世界城市排名", "url": "https://www.lboro.ac.uk/gawc/", "weight": 0.25}'),
    ('ctrip', 'ctrip', 168, true, '{"name_cn": "携程旅游", "url": "https://www.ctrip.com/", "weight": 0.15}'),
    ('gaode', 'gaode', 168, true, '{"name_cn": "高德地图", "url": "https://www.amap.com/", "weight": 0.10}'),
    ('dazhong', 'dazhong', 168, true, '{"name_cn": "大众点评", "url": "https://www.dianping.com/", "weight": 0.20}')
